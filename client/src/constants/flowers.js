// 50 Collectible Flowers — Frontend version (mirrors server/src/constants/flowers.js)

export const RARITIES = {
  common:     { id: 'common',     label: 'Common',     labelAr: 'شائعة',       weight: 50, color: '#4CAF50', bgColor: '#F1F8F1', border: '#A5D6A7' },
  uncommon:   { id: 'uncommon',   label: 'Uncommon',   labelAr: 'غير شائعة',  weight: 30, color: '#1976D2', bgColor: '#E8F1FE', border: '#90CAF9' },
  rare:       { id: 'rare',       label: 'Rare',       labelAr: 'نادرة',       weight: 15, color: '#7B1FA2', bgColor: '#F3E8FF', border: '#CE93D8' },
  ultra_rare: { id: 'ultra_rare', label: 'Ultra Rare', labelAr: 'نادرة جداً', weight:  5, color: '#E65100', bgColor: '#FFF8E1', border: '#FFCC02' },
};
...
export const FLOWERS = [
  ...
  { id: 'white_flower',  name: 'White Blossom',    arabicName: 'وردة بيضا',      emoji: '🤍', rarity: 'common',     color: '#BDBDBD', description: 'Pure and elegant in its simplicity.' },
  ...
  { id: 'chamomile',     name: 'Chamomile',        arabicName: 'بابونج',           emoji: '✿',  rarity: 'common',     color: '#FFF176', description: 'Tiny flowers used for calming tea.' },
  ...
  { id: 'gardenia',      name: 'Gardenia',         arabicName: 'جاردينيا',         emoji: '🤍', rarity: 'uncommon',   color: '#9E9E9E', description: 'Creamy white with an intoxicating perfume.' },
  ...
  { id: 'ice_flower',    name: 'Ice Flower',       arabicName: 'وردة الجليد',     emoji: '❄️', rarity: 'rare',       color: '#80DEEA', description: 'Crystalline petals that never melt.' },
...
export const FLOWER_MAP = Object.fromEntries(FLOWERS.map(f => [f.id, f]));
